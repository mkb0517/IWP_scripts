...
def makeMove(board, chests, x, y):
    ...
    # Otherwise, return the string or the result of this move.
...
def enterPlayerMove():
    # Let the player type their move. Return a two-item list of int xy coordinates.
...
When you collect a chest, all the sonar devices will update to locate the next
